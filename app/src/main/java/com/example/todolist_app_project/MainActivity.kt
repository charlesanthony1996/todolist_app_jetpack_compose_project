...
//        createWeeklyListPage(this, navController, loginViewModel)
        createManualEntryPage(this, navController, loginViewModel)
        newEntryPage(this, navController, loginViewModel)
    }
}
...
@RequiresApi(Build.VERSION_CODES.N)
 fun homePage(
    ...
    builder.composable(route = NavigationEnum.Home.name) {
        HomeScreen(
            NavigateToNewEntryScreen = { navController.navigate(NavigationEnum.NewEntryPage.name) },
            loginViewModel
        )
    }
}
...
fun newEntryPage(
    ...
    builder.composable(route = NavigationEnum.NewEntryPage.name) {
        NewEntryScreen(
            CreateManualEntryClick = { navController.navigate(NavigationEnum.ManualEntry.name) },
            viewModel = loginViewModel
        )
...
fun createManualEntryPage(
    ...
    builder.composable(route = NavigationEnum.ManualEntry.name) {
        CreateManualEntryScreen(
            CreateWeeklyListScreenClick = { navController.navigate(NavigationEnum.NewEntryPage.name) },
            loginViewModel
        )
    }
}
